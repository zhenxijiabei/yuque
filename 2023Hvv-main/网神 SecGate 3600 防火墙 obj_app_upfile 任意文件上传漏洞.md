...
![image-20230810090932372](./image/image-20230810090932372.png)

出现漏洞的文件 webui/modules/object/app.mds

![image-20230810090941737](./image/image-20230810090941737.png)

代码中没有对文件调用进行鉴权，且文件上传路径为可访问路径，造成任意文件上传

![image-20230810090957770](./image/image-20230810090957770.png)
...
![image-20230810091011621](./image/image-20230810091011621.png)